...
pub struct SettingsForm {
    ...
    pub ai_identity_subagent_conversations_chapter_id: Option<String>,
...
pub async fn handle_settings_post(
    ...
    let mut settings = UserSettings {
        ...
        ai_identity_subagent_conversations_chapter_id: parse_id(form.ai_identity_subagent_conversations_chapter_id),
